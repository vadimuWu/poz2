...
import neploxo.rest.stid.DAO.RoleDAO;
import neploxo.rest.stid.DAO.UserDAO;
...
public class UserServiceImpl implements UserService {
    ...
    public void addDefaultUser() {
        ...
        User user1 = new User("Js","Jsov",(byte) 25, "jsov@mail.com", "user","12345",roles1);
        User user2 = new User("Jwt","Jwtcoolov",(byte) 30, "admin@mail.com", "admin","admin",roles2);
        save(user1);
        save(user2);
    }
}
